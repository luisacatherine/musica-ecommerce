...
class Category(db.Model):
    ...
    url_besar = db.Column(db.String(255))
    ...
    response_fields = {
        ...
        'url': fields.String,
        'url_besar': fields.String,
        'created_at': fields.DateTime,
        'updated_at': fields.DateTime

    }

    def __init__(self, id, nama_kategori, url, url_besar, created_at, updated_at):
        self.id = id
        self.nama_kategori = nama_kategori
        self.url = url
        self.url_besar = url_besar
